...
enum TokenType {
	// Reserved Words:
	VOID_TOKEN, MAIN_TOKEN, INT_TOKEN, COUT_TOKEN, FOR_TOKEN, IF_TOKEN, WHILE_TOKEN, DOWHILE_TOKEN, ENDL_TOKEN,
	...
	AND_TOKEN, OR_TOKEN, BITWISE_TOKEN, PLUSEQUALS_TOKEN, MINUSEQUALS_TOKEN, TIMESEQUALS_TOKEN,
	// Other Token Types:
...
const std::string gTokenTypeNames[] = {
	"VOID", "MAIN", "INT", "COUT", "FOR", "IF", "WHILE", "DOWHILE", "ENDL",
	"LESS", "LESSEQUAL", "GREATER", "GREATEREQUAL", "EQUAL", "NOTEQUAL",
	"INSERTION", "ASSIGNMENT", "PLUS", "MINUS", "TIMES", "DIVIDE",
	"SEMICOLON", "LPAREN", "RPAREN", "LCURLY", "RCURLY",
	"AND", "OR", "BITWISE", "PLUSEQUALS", "MINUSEQUALS", "TIMESEQUALS",
